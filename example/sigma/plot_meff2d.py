...
def main():
    ...
    meff_HDL_plot = np.array([high_density_limit_asgadi(rs) for rs in rs_HDL_plot])
    ...
    # High-density limit
    # handle2 = plot_mvsrs(rs_HDL_plot, meff_HDL_plot, 4,
